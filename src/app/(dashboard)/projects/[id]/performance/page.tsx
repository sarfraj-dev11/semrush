...
import { getActiveProjectJob, getProjectWithClient } from "@/lib/queries";
import { formatDateTime, formatRelative } from "@/lib/utils";
import { startPsiAction } from "./actions";
import {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <Button
            ...
            asChild
          >
            <Link href={`/projects/${projectId}/performance?strategy=mobile`}>
          ...
          <Button
            ...
            asChild
          >
            <Link href={`/projects/${projectId}/performance?strategy=desktop`}>
